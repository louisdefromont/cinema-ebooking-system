...
const Payment2 = ({ email }) => {
    ...
    useEffect(() => {
        console.log('Email received in Payment3 component:', email);
      }, [email]);
   ...
   return(
       <>
           ...
           <form action="" class="register" onSubmit={handleSubmit}>
               ...
               <div style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}><Button className='button' type="submit" variant="contained" name="add" onClick={handleSubmit}>Add Payment Method and Register</Button></div>
